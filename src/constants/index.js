...
const experiences = [
  ...
  },
  {
    ...
    points: [
      "Led the revamp of the church’s website using the MERN stack (MongoDB, Express, ReactJS and NodeJS) thereby improving site speed by 55% and enhancing mobile responsiveness for a smoother user experience.",
      "Collaborated with cross-functional teams to implement new frontend features, boosting online engagement and accessibility.",
      "Optimised codebase and integrated best practices, which reduced maintenance issues and improved scalability for future updates.",
    ],
  },
  {
  ...
  {
    title: "Lead Frontend Developer",
    company_name: "L.I.F.E FOUNDATION",
    icon: life,
    iconBg: "#E6DEDD",
  ...
  {
    title: "Frontend Developer",
    company_name: "HNG TECH",
    icon: hng,
    iconBg: "#0227D4",
    date: "Oct 2022 - Dec 2022",
    points: [
      " Collaborated with a remote team to develop and maintain frontend features using HTML, CSS, and JavaScript.",
      "Gained hands-on experience with industry-standard tools and workflows such as Git, GitHub, and Agile development.",
      "Contributed to real-world projects by debugging issues and optimising code, which improved performance and usability.",
    ],
  },
];
...
const testimonials = [
  {
    ...
    company: "Acme Co",
    image:
      "https://th.bing.com/th/id/OIP.TWlqzu7Ppu755bSsv1i_qAHaLH?rs=1&pid=ImgDetMain",
  },
  {
    testimonial:
  ...
  },
  {
    ...
    image:
      "https://th.bing.com/th/id/OIP._ylU-x21IxUktAffZ7rZcAHaE8?w=186&h=124&c=7&r=0&o=5&pid=1.7",
  },
];
